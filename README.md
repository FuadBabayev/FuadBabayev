...
<p align="justify" >Web developer with one year of experience in front-end development. I have contributed to several projects, ranging from e-commerce to admin dashboard systems, where I gained extensive knowledge of HTML5, CSS3, SASS, Bootstrap, Tailwind CSS, JavaScript, jQuery, TypeScript, React, and Redux on the client side and MongoDB, Express, and NodeJS on the server side. An enthusiastic learner who has a good work ethic, is quick to pick things up, and keeps up with the newest developments in web development. Dedicated to providing dependable, high-quality solutions, possessing a strong grasp of database design and execution. I'm trying to use my expertise and abilities to help a vibrant, expanding company succeed.</p>
